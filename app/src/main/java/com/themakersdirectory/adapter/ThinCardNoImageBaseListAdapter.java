 ...
 */
public class ThinCardNoImageBaseListAdapter extends RecyclerView.Adapter<ThinCardNoImageBaseListAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.adapter_list_no_image_card, parent, false);
    ...
    @Override
    public void onBindViewHolder(final ThinCardNoImageBaseListAdapter.ViewHolder holder, final int position) {
