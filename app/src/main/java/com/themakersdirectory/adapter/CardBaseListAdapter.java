 ...
 */
public class CardBaseListAdapter extends RecyclerView.Adapter<CardBaseListAdapter.ViewHolder> {
    ...
    @Override
    public void onBindViewHolder(final CardBaseListAdapter.ViewHolder holder, final int position) {
